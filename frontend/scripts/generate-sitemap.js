/**
 * Sitemap Generator Script for Origins by the Sea
 *
...
const routes = [
  ...
  },
  {
    ...
    lastmod: CURRENT_DATE,
    description:
      "Learn about our story, values and commitment to sustainable fashion.",
  },
  {
    path: "/shop",
    changefreq: "daily",
    ...
    lastmod: CURRENT_DATE,
    description:
      "Explore our collection of handcrafted swimwear, dresses, and accessories.",
  },
  {
    path: "/shop?id=3",
    changefreq: "weekly",
  ...
  },
  {
    ...
    priority: 0.5,
    lastmod: CURRENT_DATE,
    description: "Log in to your Origins by the Sea account.",
  },
  {
    path: "/signup",
    changefreq: "monthly",
    priority: 0.5,
    lastmod: CURRENT_DATE,
    description: "Create a new account with Origins by the Sea.",
  },
  {
    ...
    priority: 0.4,
    lastmod: CURRENT_DATE,
    description: "Reset your Origins by the Sea account password.",
  },
  {
    path: "/privacy-policy",
    changefreq: "yearly",
  ...
  },
  {
    ...
    lastmod: CURRENT_DATE,
    description:
      "Track the status of your order with our order tracking system.",
  },
];
...
const humansTxt = `/* TEAM */
    Creator: Origins by the Sea Team
